...
<div class="service-edit-page">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier Service</h1>
                <p class="text-gray-600 dark:text-gray-400">{{ $service->nom }}</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nom" id="nom" value="{{ old('nom', $service->nom) }}" required
                                   class="input" placeholder="Exemple: Comptabilité">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $service->code) }}"
                                   class="input" placeholder="Exemple: COMPTA">
                        </div>

                        <div>
                            <label for="departement_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                Département <span class="text-red-500">*</span>
                            </label>
                            <select name="departement_id" id="departement_id" required class="input">
                                <option value="">Sélectionnez un département</option>
                                @foreach($departements as $departement)
                                <option value="{{ $departement->id }}" {{ old('departement_id', $service->departement_id) == $departement->id ? 'selected' : '' }}>
                                    {{ $departement->nom }}
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="entreprise_id" id="entreprise_id" {{ $service->is_global ? 'disabled' : '' }} class="input">
                                <option value="">Sélectionnez une entreprise (optionnel pour services globaux)</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="input" placeholder="Description du service...">{{ old('description', $service->description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Service actif</span>
                            </label>
                        </div>
                        ...
                        <div>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_global" value="1" {{ old('is_global', $service->is_global) ? 'checked' : '' }} class="sr-only peer">
                                <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Service global</span>
                            </label>
                            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                Un service global est disponible pour toutes les entreprises
                            </p>
                        </div>
                        @endif
                    </div>
