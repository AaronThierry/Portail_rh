                ...
                <div class="relative glass-card rounded-3xl p-6 space-y-6">
                    ...
                    <form method="POST" action="{{ route('password.send.code') }}" class="space-y-6">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
