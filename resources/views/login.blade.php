...
<body class="h-full bg-pattern">
    ...
    <!-- Theme Toggle Button - Improved Icon -->
            ...
            <div class="relative group">
                ...
                <div class="relative glass-card rounded-3xl p-6 space-y-6">
                    ...
                    <form method="POST" action="{{ route('login.submit') }}" class="space-y-6">
                        ...
                        <!-- Email Field -->
                        <div class="space-y-2">
                            <label for="courrier" class="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">
                                Adresse e-mail
                            </label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <button
                                    type="button"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 px-3 py-2 text-xs font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                >
                                <label for="remember" class="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
                                    Se souvenir de moi
                                </label>
                            </div>
                            <a href="{{ route('password.request') }}" class="text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                                Mot de passe oublié ?
                            </a>
                        </div>
    ...
    <script>
        ...
        // Keyboard shortcut (Ctrl+K for email focus)
        document.addEventListener('keydown', function(e) {
            if (e.ctrlKey && e.key === 'k') {
                e.preventDefault();
                document.getElementById('courrier')?.focus();
            }
        });
        ...
        inputs.forEach(input => {
            input.addEventListener('focus', function() {
                this.parentElement.classList.add('scale-[1.01]', 'transform');
            });
