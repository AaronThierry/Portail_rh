            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ $departement->nom }}</div>
                            @if($departement->description)
                            <div class="text-xs text-gray-500 dark:text-gray-400">{{ Str::limit($departement->description, 50) }}</div>
                            @endif
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-900 dark:text-gray-200">{{ $departement->entreprise->nom }}</div>
                            @else
                            <span class="text-gray-400">-</span>
                            @endif
                        </td>
