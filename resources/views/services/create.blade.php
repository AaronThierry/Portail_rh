...
<div class="service-create-page">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nouveau Service</h1>
                <p class="text-gray-600 dark:text-gray-400">Créez un nouveau service</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="departement_id" id="departement_id" required class="input">
                                ...
                                <option value="{{ $departement->id }}" {{ old('departement_id', request('departement_id')) == $departement->id ? 'selected' : '' }}>
                                    {{ $departement->nom }}
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="entreprise_id" id="entreprise_id" class="input">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="input" placeholder="Description du service...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
