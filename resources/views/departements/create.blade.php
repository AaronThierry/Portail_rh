...
<div class="departement-create-page">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nouveau Département</h1>
                <p class="text-gray-600 dark:text-gray-400">Créez un nouveau département</p>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="entreprise_id" id="entreprise_id" required class="input">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="input" placeholder="Description du département...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('departements.index') }}" class="btn btn-secondary w-full">
                            Annuler
                        </a>
                    </div>
                </div>
