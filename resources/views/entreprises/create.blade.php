...
@section('content')
<div class="entreprise-create-page">
    <!-- Page Header -->
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nouvelle Entreprise</h1>
                <p class="text-gray-600 dark:text-gray-400">Créez une nouvelle entreprise</p>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="pays" id="pays" value="{{ old('pays', 'Cameroun') }}" required
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="numero_registre" id="numero_registre" value="{{ old('numero_registre') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="numero_fiscal" id="numero_fiscal" value="{{ old('numero_fiscal') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="nombre_employes" id="nombre_employes" value="{{ old('nombre_employes') }}" min="1"
                        ...
                        <label for="logo" class="block">
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 text-center hover:border-primary-500 dark:hover:border-primary-400 transition-colors cursor-pointer">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    Cliquez pour choisir un logo<br>
